  ...
  return (
    <div className="page-stack">
      ...
      <div className="two-col">
        ...
        <section className="panel"><div className="panel-head"><h3>API connection</h3></div><label>Backend API URL<input value={apiBase} onChange={(e) => setApiBase(e.target.value)} /></label><button className="primary" onClick={saveApi}>Save API URL</button></section>
      </div>
